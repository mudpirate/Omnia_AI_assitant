// bershka.js - Bershka E-commerce Store Scraper (FIXED IMAGE EXTRACTION)
    ...
    const productData = await page.evaluate((selectors) => {
      ...
      if (imgEl) {
        ...
        if (imgSrc && imgSrc.includes("bershka.net")) {
          ...
          console.log(
            `     ✅ PDP Image found: ${imgSrc.substring(
      ...
      if (!data.imageUrl) {
        console.log("     ❌ No PDP image found");
      }
